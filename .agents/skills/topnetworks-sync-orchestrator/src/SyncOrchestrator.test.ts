...
describe("SyncOrchestrator", () => {
  ...
  it("should successfully execute remote deployment", async () => {
    ...
    const mockChildProcess = new EventEmitter() as unknown as import("child_process").ChildProcess;
    mockChildProcess.stdout = new EventEmitter() as unknown as import("stream").Readable;
    mockChildProcess.stderr = new EventEmitter() as unknown as import("stream").Readable;
